...
lambda.wine <- seq(v.wine - 18000,v.wine + 18000, by = 2000)
...
plot(lambda.wine, nmi.wine, type = "o", lwd=2, 
     main="wine Dataset : Plot for lambda vs ARI and NMI value", 
...
axis(1, at = seq(v.wine-18000,v.wine+18000, by = 2000), font = 2)
axis(2, at=seq(0,1,0.05), las = 2, font = 2)
abline(h=seq(0,1,0.05),v=lambda.wine, lty=3, col="gray")
